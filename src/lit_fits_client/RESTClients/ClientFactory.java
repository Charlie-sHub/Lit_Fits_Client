...
public class ClientFactory {
     ...
     * @return ColorClient
     */
    public ColorClient getColorClient(String uri) {
     ...
     */
    public MaterialClient getMaterialClient(String uri) {
     ...
     */
    public CompanyClient getCompanyClient(String uri) {
     ...
     */
    public GarmentClient getGarmentClient(String uri) {
     ...
     */
    public PublicKeyClient getPublicKeyClient(String uri) {
     ...
     * @return UserClient
     */
    public UserClient getUserClient(String uri) {
